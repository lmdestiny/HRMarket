...
<logic:iterate name="list1" id="inf" scope="request">	               
               <TR  align="center" class="line4"> 
               <TD width="10%"><bean:write name="inf" property="djtime"/>${z.dojsj}</TD>
               <TD width="10%"><bean:write name="inf" property="djreason"/>${z.dojyy}</TD>
                 <TD width="10%"><bean:write name="inf" property="jdtime"/>${z.jidsj}</TD>
               <TD width="10%"><bean:write name="inf" property="jdreason"/>${z.jidyy}</TD>
               </TR>
 </logic:iterate>
</logic:present>               
   		</TBODY>
