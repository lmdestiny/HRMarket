			...
			$.getJSON("dwdjInfo.do",{frm:frm,code:"blur"},function(data){
				if(data!=null){
					...
					if(confirm("用户已存在是否显示该用户")){
							...
							$.get("dwdjInfo.do",{code:"dwszq",textd:data.bio_rga_regioncode},function(d){
								$("#dwszq").html(d);
							});
							$.get("dwdjInfo.do",{code:"dwszj",textd:data.bio_rga_regioncode},function(d){
								$("#dwszj").html(d);
							});
						...
						<tr>
							<td valign="top">
								<table width="100%" border="0" cellspacing="1" cellpadding="0">
									<tr class="line2">
										<td width="13%" align="right"><span class="redtxt">*</span>单位法人码
										</td>
										<td width="18%"><input name="dwfrm" id="dwfrm"
											style="WIDTH: 100%" maxlength="32"></td>
										<td width="13%" align="right"><span class="redtxt">*</span>单位全称
										</td>
										<td width="20%"><INPUT name="dwqc" id="dwqc"
											style="WIDTH: 100%" maxlength="64" value=""
											onkeyup=copyValue();;></td>
										<td width="14%" align="right">单位简称</td>
										<td width="20%"><INPUT name="dwjc" id="dwjc"
											style="WIDTH: 100%" maxlength="32" value=""></td>
									</tr>
									<tr class="line1">
										<td align="right"><span class="redtxt">*</span>单位性质</td>
										<td width="18%"><select id="dwxz" name="dwxz"
											style="WIDTH: 100%;">

										</select></td>
										<td align="right"><span class="redtxt">*</span>经济类型</td>
										<td><select id="dwjjlx" name="dwjjlx" style="WIDTH: 100%">


										</select></td>
										<td align="right"><span class="redtxt">*</span>单位行业</td>
										<td><select id="dwhy" name="dwhy" style="WIDTH: 100%">
									...
									<tr class="line2">
										...
										<td><INPUT name="yzbm" id="yzbm" style="WIDTH: 100%"
											maxlength="32"></td>
										<td align="right">传真机号</td>
										<td><input name="czjh" id="czjh" style="WIDTH: 100%"
											maxlength="32" value=""></td>
										<td align="right">Email</td>
										<td><INPUT name="email" id="email" style="WIDTH: 100%"
											maxlength="64" value=""></td>
									</tr>
									<tr class="line1">
										<td align="right"><span class="redtxt">*</span>注册省(市)</td>
										<td><select id="dwszs" name="dwszs" style="WIDTH: 100%"
											onchange="initCity()"> ${Regioncode }
									...
									<tr class="line2">
										...
										<td colspan="5"><INPUT name="lxdz" id="lxdz"
