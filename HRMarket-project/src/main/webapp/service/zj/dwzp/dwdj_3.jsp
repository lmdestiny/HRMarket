...
<script type="text/javascript">
	$(function(){
		...
		$.get("dwdj_1.do",{code:"zpgz"},function(data){
			$("#zpgz").html(data);
		});
				...
				<td align="center" valign="top">
					...
					<table width="98%" border="0" cellpadding="0" cellspacing="1">
						...
						<tr class="line1">
							...
							<td colspan="3">男 <INPUT name="nars" id="nars" size="1">
								女 <INPUT name="nvrs" id="nvrs" size="1"> 不限 <INPUT
						...
						<tr class="line1">
							...
							<td>
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td width="45%"><INPUT name="zdyx" style="WIDTH: 100%"
						...
						<tr class="line2">
							...
							<td align="right">熟练程度</td>
							<td><select id="yzslcd" name="yzslcd" style="WIDTH: 100%">
									${Proficiency}
