...
<html>
<head>
<title>：：欢迎${login.userName}同志访问劳动力市场信息系统：：</title>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td><a href="<%=request.getContextPath()%>/framesleft?restype=05"  target="leftFrame"><img src="<%=request.getContextPath()%>/styles/images/index/lm_4.jpg" width="57" height="25" border="0" id="Image4" onMouseOver="MM_swapImage('Image4','','<%=request.getContextPath()%>/styles/images/index/lm_4a.jpg',1)" onMouseOut="MM_swapImgRestore()"></a></td>
